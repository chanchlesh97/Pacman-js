  ...
  (0, _createClass2.default)(GameBoard, [{
    ...
    value: function createGrid(level) {
      ...
      level.forEach(function (element) {
        var div = document.createElement('div');
        div.classList.add('square', _setup.CLASS_LIST[element]);
        ...
        if (_setup.CLASS_LIST[element] === _setup.OBJECT_TYPE.DOT) _this.dotCount++;
      });
    }
  }, {
    key: "addObject",
    ...
    value: function moveCharacter(character) {
      if (character.shouldMove()) {
        ...
        this.removeObject(character.pos, classesToRemove); // console.log(direction);
...
var Pacman = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Pacman, [{
    ...
    value: function getNextMove(objectExists) {
      var nextMovePos = this.pos + this.dir.movement; //print(objectExits);
  ...
  (0, _createClass2.default)(Ghost, [{
    ...
    value: function getNextMove(objectExists) {
      ...
      var _this$movement = this.movement(this.pos, this.dir, objectExists),
          ...
          direction = _this$movement.direction; //console.log(nextMovePos+"^ ");
...
var startButton = document.querySelector('#start-button'); //Game Constant
...
function startGame() {
  ...
  gameBoard.addObject(287, [_setup.OBJECT_TYPE.PACMAN]); //console.log(gameBoard);

  document.addEventListener('keydown', function (e) {
    return pacman.handleKeyInput(e, gameBoard.objectExists.bind(gameBoard));
  });
  var ghosts = [new _Ghost.Ghost(5, 188, _ghostMoves.randomMovement, _setup.OBJECT_TYPE.BLINKY), new _Ghost.Ghost(4, 209, _ghostMoves.randomMovement, _setup.OBJECT_TYPE.PINKY), new _Ghost.Ghost(3, 230, _ghostMoves.randomMovement, _setup.OBJECT_TYPE.INKY), new _Ghost.Ghost(2, 251, _ghostMoves.randomMovement, _setup.OBJECT_TYPE.CLYDE)]; //  ghosts.forEach((ghost)=>{
